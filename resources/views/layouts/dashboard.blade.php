                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                @if (Auth::user()->staff)
                                    <img class="img-profile rounded-circle" src="{{ asset(Auth::user()->staff->foto) }}">
                                    @elseif(Auth::user()->guru)
                                    <img class="img-profile rounded-circle" src="{{ asset(Auth::user()->guru->foto) }}">
                                    @elseif(Auth::user()->siswa)
                                    <img class="img-profile rounded-circle" src="{{ asset(Auth::user()->siswa->foto) }}">
                                    @elseif(Auth::user()->walimurid)
                                    <img class="img-profile rounded-circle" src="{{ asset(Auth::user()->walimurid->foto) }}">
                                @endif
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; MDK Technology 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
